...
const SearchComponent = ({ onClick, query, excludeMovieIds, toast }) => {
    ...
    const handleSearch = async (query) => {
        if (query.trim() === '') {
            toast.error('Search query cannot be empty', toastProps);
            return;
        }
        try {
            setLoading(true);
            ...
            <div className="items-center p-4 lg:px-40 md:px-20 flex flex-wrap">
                <div className="flex flex-col flex-wrap w-full mb-4 w-full">
                    <div className='flex flex-row'>
                        ...
                        <button
                            ...
                            onClick={() => searchInput(searchQuery)}
                            id="searchButton"
                        >
                            Search
                        </button>
                ...
                <div className='flex flex-row w-full flex-wrap mb-4 gap-10'>
                    <div className='flex flex-row lg:flex-col pl-5 pt-10 pb-10 gap-y-10 justify-between h-fit bg-gray-200 w-full lg:w-1/4 rounded-md shadow-lg'>
                        <div>
                            <label htmlFor="selectGenre" className="mr-2">Filter by Genre:</label>
                            <select
                        ...
                        <div>
                            <label htmlFor="selectCountry" className="mr-2">Filter by Country:</label>
                            <select
                                className="border border-gray-300 rounded-md p-2 w-11/12"
                            ...
                            searchResults.map((movie) => (
                                ...
                                >
                                    <div className="flex">
                                        ...
                                        <div>
                                            <div className="font-semibold">{movie.title || "Unknown Title"}</div>
